<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/content/activity.js"></script>
<div id="activity-tool-bar" style="padding: 10px">
    <div class="easyui-linkbutton " id="activity-select-btn" data-options="iconCls:'icon-reload'" style="width:70px">刷新
    </div>
    <div class="easyui-linkbutton " id="activity-save-btn" data-options="iconCls:'icon-add'" style="width:70px">新增</div>
    <div class="easyui-linkbutton " id="activity-update-btn" data-options="iconCls:'icon-edit'" style="width:70px">修改</div>
    <div class="easyui-linkbutton " id="activity-delete-btn" data-options="iconCls:'icon-remove'" style="width:70px">删除
    </div>
</div>
<div id="activity_grid" style="padding: 10px"></div>

<div class="pagewrap" >
	<div class="rowz">
		<div class="label">活动名称：</div>
		<div class="contentz">
			<input type="text" class="colortitle" id="activityName" value="">
			<div class="colorbtn">
	...
	<div class="rowz">
		...
		<div class="contentz">
			<textarea id="editor_activity" name="content" style="width:100%;height:400px;"></textarea>
