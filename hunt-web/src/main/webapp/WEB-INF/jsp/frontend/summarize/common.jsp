            ...
            'successcallback':function(data, current_page){
                ...
                if(titel == 'travel'){
        	        $.each(data.rows,function(i,n){
        	            str+='<li><a href="'+'${pageContext.request.contextPath}/frontend/travel/details?id='+n.id+'"><img src="${pageContext.request.contextPath}'+n.image+'" alt="" /><div class="main_font"><div class="main_title"><p>'+n.travelName+'</p></div><div class="main_font_content"><p>'+n.travelContent+'</p></div></div></a></li>'
        	        })
                }else if(titel == 'culture'){
                	 $.each(data.rows,function(i,n){
         	            str+='<li><a href="'+'${pageContext.request.contextPath}/frontend/culture/details?id='+n.id+'"><img src="${pageContext.request.contextPath}'+n.image+'" alt="" /><div class="main_font"><div class="main_title"><p>'+n.cultureName+'</p></div><div class="main_font_content"><p>'+n.cultureContent+'</p></div></div></a></li>'
         	        })
                }else{
                	 $.each(data.rows,function(i,n){
          	            str+='<li><a href="'+'${pageContext.request.contextPath}/frontend/specialty/details?id='+n.id+'"><img src="${pageContext.request.contextPath}'+n.image+'" alt="" /><div class="main_font"><div class="main_title"><p>'+n.specialtyName+'</p></div><div class="main_font_content"><p>'+n.specialtyContent+'</p></div></div></a></li>'
          	        })
                }
                str+='</ul>'	
                mainwrap.html(str)               
