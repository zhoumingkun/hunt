...
<head>
    ...
    <title>走进娄烦</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/resources/common.css">
    ...
    <script src="${pageContext.request.contextPath}/static/js/resources/common.js"></script>
</head>
        ...
        <div class="right">
            ...
            <div class="main">
                ...
                <div class="survey common_content">
                    <div class="survey_title">
                        <div class="survey_title_img">
                            <img src="${pageContext.request.contextPath}/static/image/resources/common2.jpg" alt="">
                        </div>
                        <p>山西省娄烦县</p>
                    </div>
                    <div class="survey_font">
                        <p>娄烦县是山西省太原市下辖县，地理坐标为东经111°31′—112°02′，北纬37°51′—38°13′，地处太原市西北部、吕梁山腹地、汾河中上游，距省城太原97公里，东依古交，西邻方山，南毗交城，北连静乐，西北与岚县接壤，是集山区、老区、库区为一体的国家扶贫开发重点县，
                            [1] 也是太原最重要的水源地和生态屏障。 娄烦县属温带大陆性气候，总的特征是气候干旱，雨量较少，气温较低，风力较小，光照充足，湿热同季，分季节看：冬季漫长、干燥寒冷，夏季炎热、雨季集中，春季风多、升温较快，秋季短暂，天气凉爽。年平均风速2.5米/秒。日照总时数为2872.6小时。</p>
                        <p>经济编辑概况 娄烦建县以后，1996年，娄烦生产总值33 198万元，娄烦县娄烦县为1978年的17.3倍；工业总产值46 315万元，为1978年的70.1倍；农林牧渔业总产值8033万元，为1978年的1.6倍；社会消费品零售总额6131万元，为1978年的5.4倍，扣除物价因素为1.3倍；地方财政收入1251万元，为1978年的29倍。
                            2008年，娄烦县生产总值完成13亿元、同比增长7%，财政收入6.68亿元、同比增长66.3%；工业企业共投入技改和节能建设资金5.88亿元，万元工业增加值能耗同比下降7.8%。 2012年6月，娄烦有煤矿8座，生产能力690万吨/年，有非煤矿山企业15家（含尖山铁矿），砖瓦粘土企业8家。铝钒土矿1家，设计能力10万吨；长石矿1家，设计生产能力0.5万吨；白云岩矿2家，设计生产能力14万吨；另有炼铁厂企业1家，30万立方米高炉。焦化厂3家，生产能力160万吨。
                        </p>
                        <p>娄烦建县以后，1996年，娄烦生产总值33 198万元，娄烦县娄烦县为1978年的17.3倍；工业总产值46 315万元，为1978年的70.1倍；农林牧渔业总产值8033万元，为1978年的1.6倍；社会消费品零售总额6131万元，为1978年的5.4倍，扣除物价因素为1.3倍；地方财政收入1251万元，为1978年的29倍。</p>
                ...
                <ul class="common_content">
                    <li>
                        <a href="details.html">
                            <img src="${pageContext.request.contextPath}/static/image/resources/common1.jpg" alt="" />
                            <div class="main_font">
                ...
                <ul class="common_content">
                    <li>
                        <a href="details.html">
                            <img src="${pageContext.request.contextPath}/static/image/resources/common3.jpg" alt="" />
                            <div class="main_font">
                                <div class="main_title">
                                    <p>做年饭</p>
                                </div>
                ...
                <ul class="common_content">
                    <li>
                        <a href="details.html">
                            <img src="${pageContext.request.contextPath}/static/image/resources/common4.jpg" alt="" />
                            <div class="main_font">
                                <div class="main_title">
                                    <p>莜面面食</p>
                                </div>
